...
function Content() {
  ...
  return (
    <section id="photographyInfo" className="py-12">
      <div className="container mx-auto animate-fade-in bg-white p-8 rounded-lg drop-shadow-2xl ">
      <h2 className="text-3xl font-semibold text-center mb-8 bg-black rounded-xl text-white p-2 rounded-full drop-shadow-sm animate-pulse ">
          Photography
        </h2>
